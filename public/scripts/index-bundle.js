...
function changeText() {
  ...
  function nextWord() {
    ...
    if (currentIndex < words.length) {
      var _nextLetter = function nextLetter() {
        if (letterIndex < currentWord.length) {
          element.textContent += currentWord[letterIndex];
          letterIndex++;
          setTimeout(_nextLetter, 100);
        } else {
          currentIndex++;
          element.textContent += ' ';
...
var navListItem = document.getElementsByClassName("nav-ul")[0];
...
var input = document.getElementById("dark-mode-toggle");
...
var darkModeBtn = document.querySelector(".toggle-dark-light");
